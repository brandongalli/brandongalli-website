                        ...
                        <div className="contact-content">
                            <div className="top">
                                <ul>
                                    ...
                                    <li>
                                        <span>Email:</span>
                                        <a href="mailto:hello@reton.com">brandongalli32@gmail.com</a>
                                    </li>
                                    <li>
                                        <span>Website:</span>
                                        <a href="#" target="_blank">www.brandongalli.com</a>
                                    </li>
                                    <li>
                                        <span>Address:</span>
                                        <a href="#" target="_blank">Seattle, WA, 98102, United States</a>
                                    </li>
                                </ul>
                            </div>
